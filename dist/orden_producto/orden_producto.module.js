...
const orden_producto_controller_1 = require("./orden_producto.controller");
...
exports.OrdenProductoModule = OrdenProductoModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([orden_producto_entity_1.OrdenProducto])],
        controllers: [orden_producto_controller_1.OrdenProductoController],
        providers: [orden_producto_service_1.OrdenProductoService],
    })
], OrdenProductoModule);
//# sourceMappingURL=orden_producto.module.js.map